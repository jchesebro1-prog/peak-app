...
export function catalogSeed(): CatalogPart[] {
  return [
    ...
    { id: "RB-EN-16", sku: "RB-EN-16", desc: "16 oz Encore Velour", category: "Fabric", unit: "sq ft", list: 3.95, cost: 2.60, mfr: "Rose Brand", costPerSqft: 2.60, oz: 16, ozBasis: "lin-yd", boltWidthIn: 54, curtainAreaRate: 2.1 },
    ...
    { id: "RB-MUS", sku: "RB-MUS", desc: "Seamless Muslin", category: "Fabric", unit: "sq ft", list: 1.70, cost: 1.10, mfr: "Rose Brand", costPerSqft: 1.10, oz: 6, ozBasis: "sq-yd", boltWidthIn: 120, curtainAreaRate: 0.9 },
    ...
    { id: "RIG-LBR", sku: "RIG-LBR", desc: "Rigging — install labor", category: "Labor", unit: "hr", list: 75, cost: 75, discipline: "RIG", role: "labor" },
    ...
    { id: "LIG-LBR", sku: "LIG-LBR", desc: "Lighting — install labor", category: "Labor", unit: "hr", list: 68, cost: 75, discipline: "LIG", role: "labor" },
    { id: "LIG-OT", sku: "LIG-OT", desc: "Lighting — overtime labor", category: "Labor", unit: "hr", list: 90, cost: 75, discipline: "LIG", role: "ot" },
    { id: "LIG-SUP", sku: "LIG-SUP", desc: "Lighting — supervisor", category: "Labor", unit: "hr", list: 110, cost: 75, discipline: "LIG", role: "sup" },
    { id: "AUD-LBR", sku: "AUD-LBR", desc: "Audio — install labor", category: "Labor", unit: "hr", list: 72, cost: 75, discipline: "AUD", role: "labor" },
    { id: "AUD-OT", sku: "AUD-OT", desc: "Audio — overtime labor", category: "Labor", unit: "hr", list: 105, cost: 75, discipline: "AUD", role: "ot" },
    { id: "AUD-SUP", sku: "AUD-SUP", desc: "Audio — supervisor", category: "Labor", unit: "hr", list: 108, cost: 75, discipline: "AUD", role: "sup" },
    { id: "VID-LBR", sku: "VID-LBR", desc: "Video — install labor", category: "Labor", unit: "hr", list: 72, cost: 75, discipline: "VID", role: "labor" },
    { id: "VID-OT", sku: "VID-OT", desc: "Video — overtime labor", category: "Labor", unit: "hr", list: 105, cost: 75, discipline: "VID", role: "ot" },
    { id: "VID-SUP", sku: "VID-SUP", desc: "Video — supervisor", category: "Labor", unit: "hr", list: 108, cost: 75, discipline: "VID", role: "sup" },
    { id: "SHP-PM", sku: "SHP-PM", desc: "Shop — project management", category: "Labor", unit: "hr", list: 135, cost: 75, role: "shop" },
    { id: "SHP-IN", sku: "SHP-IN", desc: "Shop — in-house fabrication", category: "Labor", unit: "hr", list: 60, cost: 75, role: "shop" },
    { id: "DRF-SUB", sku: "DRF-SUB", desc: "Engineering — drawings & submittals", category: "Labor", unit: "hr", list: 75, cost: 75, role: "shop" },
    { id: "TVL-MIL", sku: "TVL-MIL", desc: "Travel — vehicle mileage", category: "Labor", unit: "mi", list: 1, cost: 0.7, role: "travel" },
