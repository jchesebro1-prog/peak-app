...
export const metadata = { title: "Customers — Peak Backend" };
...
export default async function CustomersPage({
  ...
  const mapBtn = (
    <Link
      href="/customers?view=map"
      title="View all customer locations on a map"
  ...
  return (
    <>
        ...
        <div style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "12px 24px", background: "#fff", borderBottom: "1px solid #ececf0", flexShrink: 0 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 9, minWidth: 0 }}>
              <span style={{ fontSize: 15, fontWeight: 600 }}>Customer map</span>
        ...
        <div className="pk-content" style={{ maxWidth: 760, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, gap: 12, flexWrap: "wrap" }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 9 }}>
              <span style={{ fontSize: 23, fontWeight: 600, letterSpacing: "-.015em" }}>Customers</span>
          ...
          {!hasCustomers ? (
            <div className="pk-card" style={{ padding: "60px 30px", textAlign: "center" }}>
              <div style={{ fontSize: 16, fontWeight: 600, color: "#3a3f4a" }}>No customers yet</div>
              <div style={{ fontSize: 13, color: "#9aa0ab", marginTop: 6 }}>
                Add your first customer to start building quotes and projects.
              </div>
              <Link
                href="/customers?edit=new"
            ...
            <div className="pk-card" style={{ padding: 0, overflow: "hidden" }}>
              ...
              {filtered.length === 0 && (
                <div style={{ padding: "50px 22px", textAlign: "center", color: "#9aa0ab", fontSize: 13 }}>
                  {ql ? `No customers match “${q.trim()}”.` : "No customers match these filters."}
                </div>
              )}
            </div>
          )}
      ...
      {edit === "new" && <EditCustomerModal mode="new" initial={null} closeHref="/customers" />}
    </>
  );
}
