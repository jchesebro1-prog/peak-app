      ...
      <div className="pk-reports-sales-grid">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, minWidth: 0 }}>
          <ChartCard
            ...
            right={<Legend items={[{ color: "#dfe2e8", label: "Quoted" }, { color: ACCENT, label: "Won" }]} />}
          >
      ...
      <div style={GRID_MAIN}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, minWidth: 0 }}>
          <ChartCard
            ...
            right={<Legend items={[{ color: "#dfe2e8", label: "To be billed" }, { color: ACCENT, label: "Expected collected" }]} />}
          >
