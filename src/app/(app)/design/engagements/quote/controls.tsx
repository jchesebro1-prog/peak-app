      ...
      <form action={saveConsultingQuote}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
          {disciplineOptions.map((d) => (
            <label key={d} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12.5, color: disciplineMenu.includes(d) ? "#3a3f4a" : "#9a7d1f", cursor: "pointer" }} title={disciplineMenu.includes(d) ? undefined : "This discipline was removed from Settings. It stays on this quote until you untick it and save — after that it can’t be added back."}>
              <input
                type="checkbox"
